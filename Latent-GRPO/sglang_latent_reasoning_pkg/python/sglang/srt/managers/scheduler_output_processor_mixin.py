...
class SchedulerOutputProcessorMixin:
            ...
            for i, (req, next_token_id) in enumerate(zip(batch.reqs, next_token_ids)):
                ...
                if req.is_chunked <= 0:
                    ...
                    if self.enable_latent:
                        req.update_latent_info(logits_output, i)   
                    # ==========
    ...
    def process_batch_result_decode(
        ...
        for i, (req, next_token_id) in enumerate(zip(batch.reqs, next_token_ids)):
            ...
            if req.return_logprob and batch.spec_algorithm.is_none():
                ...
                if req.sampling_params.latent_mode:
    ...
    def stream_output_generation(
        ...
        # begin of latent reasoning
        # ==========
        # Always initialize latent output lists so they exist regardless of flag
        output_topk_probs_list = []
        output_topk_original_probs_list = []
        output_topk_original_indices_list = []
        ...
        for req in reqs:
            ...
            if (
                ...
                if self.enable_latent:
                    ...
                    output_topk_original_probs_list.append(req.get_output_topk_original_prob_list())
                    output_topk_original_indices_list.append(req.get_output_topk_original_indice_list())
