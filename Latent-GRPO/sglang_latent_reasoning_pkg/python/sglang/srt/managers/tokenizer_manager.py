...
class TokenizerManager:
    ...
    def __init__(
        ...
        self.model_config = ModelConfig(
            ...
            # ==========
            enable_latent=server_args.enable_latent,
            latent_end_token_id=server_args.latent_end_token_id,
    ...
    def _handle_batch_output(
        ...
        for i, rid in enumerate(recv_obj.rids):
            ...
            if self.enable_latent:
                ...
                meta_info["output_topk_original_prob_list"] = (
                    recv_obj.output_topk_original_probs_list[i]
                )
                meta_info["output_topk_original_indice_list"] = (
                    recv_obj.output_topk_original_indices_list[i]
                )
