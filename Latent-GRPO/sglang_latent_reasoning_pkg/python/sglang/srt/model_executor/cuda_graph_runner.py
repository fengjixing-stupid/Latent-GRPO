...
class CudaGraphRunner:
    ...
    def __init__(self, model_runner: ModelRunner):
        ...
        self.enable_latent = model_runner.server_args.enable_latent
        ...
        with torch.device("cuda"):
            ...
            # ==========
            self.input_ids = None if self.enable_latent else torch.zeros((self.max_num_token,), dtype=torch.int64) 
            ...
            self.probs = torch.zeros((self.max_bs, self.model_runner.model_config.vocab_size), dtype=self.model_runner.dtype) if self.enable_latent else None
            # self.topk_indices = torch.zeros((self.max_bs, 1024), dtype=torch.int64) if self.enable_latent else None
            # ==========
