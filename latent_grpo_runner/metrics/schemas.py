...
def schema_manifest() -> dict:
    ...
    probe_benchmark = [
        ...
        _field("probe_rng_restore_succeeded", "bool", 4, nullable=False),
        _field("parameters_unchanged", "bool", 4, nullable=False),
        _field("optimizer_state_unchanged", "bool", 4, nullable=False),
        _field("training_grads_unchanged", "bool", 4, nullable=False),
        _field("cpu_rng_restored", "bool", 4, nullable=False),
        _field("cuda_rng_restored", "bool", 4, nullable=False),
        _field("python_rng_restored", "bool", 4, nullable=False),
        _field("numpy_rng_restored", "bool", 4, nullable=False),
        _field("module_mode_restored", "bool", 4, nullable=False),
        _field("extra_loss_backward_executed", "bool", 4, nullable=False),
        _field("extra_optimizer_step_executed", "bool", 4, nullable=False),
        _field("record_available", "bool", 4, nullable=False),
        _field("record_unavailable_reason", "string", 4),
    ]
    deferred = {
