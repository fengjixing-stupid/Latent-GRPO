...
def test_final_docs_include_copy_paste_commands_and_runtime_deferral() -> None:
    ...
    for required in (
        ...
        "LOW_MODEL_PATH=/data/models/LLaMA3.2-1B-Instruct-Latent-SFT-Top10",
        "HIGH_MODEL_PATH=/data/models/Qwen2.5-Math-7B-Latent-SFT-4k-Top10",
        "LOW_TRAIN_DATA=/data/latent-grpo/GSM8k-Aug-oss-dup-all.parquet",
        "HIGH_TRAIN_DATA=/data/latent-grpo/DAPO-Math-17k-en-train.parquet",
